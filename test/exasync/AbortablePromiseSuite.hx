    ...
    public function new() {
        ...
        describe("AbortablePromise.resolve()", {
            it("should call resolved(_)", function(done) {
                AbortablePromise.resolve().then(function(_) {
                    done();
                }, function(_) {
                    fail();
                });
        ...
        describe("AbortablePromise.reject()", {
            it("should call rejected(x)", function(done) {
                AbortablePromise.reject("error").then(function(_) {
                    fail();
                }, function(e) {
                    EqualsTools.deepEqual(e, "error").should.be(true);
                    done();
            ...
            describe("chain", {
                describe("from resolved", {
                    ...
                    it("should not call 1st-then()", function(done) {
                        AbortablePromise.resolve(1).then(null, function(e) {
                            fail();
                            return -1;
                        }).then(function(x) {
                            x.should.be(1);
                ...
                describe("from rejected", {
                    it("should chain using value", function(done) {
                        AbortablePromise.reject("error").then(null, function(e) {
                            return 1;
                        }).then(function(x) {
                            return x + 100;
                        }).then(function(x) {
                    ...
                    it("should not call 1st-then()", function(done) {
                        AbortablePromise.reject("error").then(function(x) {
                            fail();
                            return -1;
                        }).then(null, function(e) {
                            (e : String).should.be("error");
            ...
            describe("chain", {
                describe("from resolved", {
                    it("should not call catchError()", function(done) {
                        AbortablePromise.resolve(1).catchError(function(e) {
                            fail();
                            return -1;
                        }).then(function(x) {
                            x.should.be(1);
            ...
            describe("chain", {
                describe("from resolved", {
                    it("should chain", function(done) {
                        AbortablePromise.resolve(1).finally(function() {}).then(function(x) {
                            return x + 100;
                        }).then(function(x) {
                            x.should.be(101);
                            done();
                ...
                describe("from rejected", {
                    it("should chain", function(done) {
                        AbortablePromise.reject("error").finally(function() {}).catchError(function(e) {
                            (e : String).should.be("error");
                            done();
                        });
                    });
